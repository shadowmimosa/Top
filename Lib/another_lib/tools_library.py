...
###绑定host
	def bindhost(self,ip,host):
		...
		shutil.copyfile("C:\Windows\System32\drivers\etc\hosts","C:\Windows\System32\drivers\etc\hoststemp")
		s = rhosts.read()
		s2 = re.sub(p, '', s)
		if(s2[len(s2)-1]=='\n'):
...
###还原hosts文件	
	def restorehost(self):
		...
		| restorehost |
		"""
		shutil.copyfile("C:\Windows\System32\drivers\etc\hoststemp","C:\Windows\System32\drivers\etc\hosts")

#db connect
	def _db_conn(self):
		return pymysql.connect(host='10.16.6.90', port=3306, user='fanxing', passwd='kugou2014', db='d_fanxing', charset='utf8')
...
if __name__ == '__main__':
	t = tools_library()
	t.enterRoom(1012021,39089058,39089059)
