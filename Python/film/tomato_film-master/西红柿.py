...
import pandas as pd
import os
from pyecharts import Bar, Geo, Line, Overlap, Map
import jieba
from scipy.misc import imread  # 这是一个处理图像的函数
from wordcloud import WordCloud, ImageColorGenerator
import matplotlib.pyplot as plt
from collections import Counter
os.chdir('C:/Users/ShadowMimosa/Desktop/STU/Top/Python/film/tomato_film-master')

# # 设置headers和cookie
# header = {
#     'User-Agent':
#     'Mozilla/5.0 (Windows NT 10.0; Win32; x32; rv:54.0) Gecko/20100101 Firefox/54.0',
#     'Connection':
#     'keep-alive'
# }
...
# 可以直接读取我们已经爬到的数据进行分析
# f = open("C:/Users/ShadowMimosa/Desktop/STU/Top/Python/tomato_film-master/西虹市首富.xlsx", encoding='gb18030', errors='ignore')
# tomato_com = pd.read_excel(f)
...
data = [(city_score_area['city'][i], city_score_area['mean'][i])
        for i in range(0, city_score_area.shape[0])]
geo = Geo(
    '《西虹市首富》全国主要城市打分图',
    title_color="#fff",
    title_pos="center",
