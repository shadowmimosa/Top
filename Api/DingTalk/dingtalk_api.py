...
class DingTalk:
    ...
    def __depart_custome_info(self,
                              m_department_id="1",
                              m_offset="0",
                              m_size="10"):
    ...
    def __get_sub_deptd(self):
        ...
        if recive["errcode"] == 0:
            ...
            for id in recive["sub_dept_id_list"]:
                self.__depart_custome_info(m_department_id=id,
                                           m_offset="0",
                                           m_size=100)
    ...
    def send_message(self):
        ...
        for Mobile in self.Mobile_list:
            data = {
                ...
                'userid_list': self.Info_List[Mobile].userid
            }
    ...
    def File(self, recive):
        ...
        msg_dict["msg"] = {"msgtype": "file", "file": {"media_id": recive}}
    ...
    def Html(self):
        ...
        msg_dict["msg"] = {
            ...
            "action_card": {
                ...
                "markdown":
                "消息通知:\n\n{0}\n\n(点击链接可查看消息内容)\n{1}".format(
                    self.Markdown, Action_Url + self.UUID),
                "single_title":
                "查看详情",
                "single_url":
                Action_Url + self.UUID
            }
        }
...
if __name__ == '__main__':
    DT = DingTalk("13474248914",
                  Type="Html",
                  Content="12345678987654321",
                  Title="1234")
    DT.send_message()